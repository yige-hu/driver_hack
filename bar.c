...
char *bar(void * __kallsyms_lookup_name,
    void * _printk, int a, char * c) {
  ...
  kallsyms_lookup_name = __kallsyms_lookup_name;

//  void *addr_ptrk = (void *) (0xffffffff8171aab1);
  void *addr_ptrk = (void *) kallsyms_lookup_name("printk");
